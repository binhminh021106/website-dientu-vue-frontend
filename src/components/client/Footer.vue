<template>
  <footer class="text-white pt-5 pb-3 mt-5 roboto-font" style="background-color: #212529; font-size: 0.9rem;">
    <div class="container border-bottom border-secondary border-opacity-50 pb-4">
      <div class="row gy-4">
        ...
        <div class="col-lg-3 col-md-6 pe-lg-4">
          ...
          <div class="mb-3">
            ...
            <a href="mailto:support@techzone.vn" class="text-decoration-none text-light text-opacity-75 hover-brand">support@techzone.vn</a>
          </div>
          <div>
            <span class="fw-bold d-block">Hotline</span>
            <a href="tel:19006750" class="text-decoration-none text-light text-opacity-75 hover-brand">1900 6750</a>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-md-6">
          ...
          <div class="d-flex gap-2 mb-4">
            ...
            <a href="#" class="social-icon bg-primary text-white d-flex align-items-center justify-content-center rounded-circle fs-5" style="width: 36px; height: 36px;"><i class="fa-brands fa-linkedin-in"></i></a>
            <a href="#" class="social-icon bg-danger text-white d-flex align-items-center justify-content-center rounded-circle fs-5" style="width: 36px; height: 36px;"><i class="fa-brands fa-youtube"></i></a>
          ...
          <div class="d-flex flex-wrap gap-2 align-items-center">
            ...
            <div class="payment-icon bg-white px-2 py-1 rounded d-flex align-items-center justify-content-center" style="height: 25px;">
              <span class="fw-bold" style="color: #1A1F71; font-family: 'Arial'; font-style: italic; font-size: 1rem; line-height: 1;">VISA</span>
            </div>
            <!-- Icon Mastercard -->
            <div class="payment-icon bg-white px-1 py-1 rounded d-flex align-items-center justify-content-center" style="height: 25px;">
               <div class="d-flex position-relative align-items-center justify-content-center" style="width: 35px;">
                 <div class="rounded-circle bg-danger" style="width: 14px; height: 14px; position: absolute; left: 4px; opacity: 0.8;"></div>
                 <div class="rounded-circle bg-warning" style="width: 14px; height: 14px; position: absolute; right: 4px; opacity: 0.8;"></div>
               </div>
            </div>
            <!-- Icon JCB -->
            <div class="payment-icon bg-white px-2 py-1 rounded d-flex align-items-center justify-content-center" style="height: 25px;">
               <span class="fw-bold text-success" style="font-family: 'Arial'; font-size: 0.9rem; line-height: 1;">JCB</span>
            </div>
            <!-- Icon VNPAY -->
            <div class="payment-icon bg-white px-2 py-1 rounded d-flex align-items-center justify-content-center" style="height: 25px;">
               <span class="fw-bolder" style="color: #004a9c; font-family: 'Arial'; font-size: 0.85rem; line-height: 1; letter-spacing: -0.5px;">VN<span style="color: #ed1c24;">PAY</span></span>
            </div>
             <!-- Icon MoMo -->
            <div class="payment-icon bg-white px-2 py-1 rounded d-flex align-items-center justify-content-center" style="height: 25px;">
               <span class="fw-bolder" style="color: #a50064; font-family: 'Arial'; font-size: 0.85rem; line-height: 1;">mo<br><span style="font-size: 0.5rem; display: block; margin-top: -3px;">mobile money</span></span>
            </div>
          </div>
        </div>
